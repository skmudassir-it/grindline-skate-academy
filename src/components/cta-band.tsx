...
export function CtaBand({
  ...
  subtitle = "Book your first lesson today — gear included, no commitment. Our coaches will have you rolling in no time.",
      ...
      <Reveal className="mx-auto max-w-6xl">
        <div className="glass-card relative overflow-hidden rounded-3xl">
          <div className="absolute inset-0 -z-10">
            <Image
              src={image}
              alt="Skateboarder mid-trick at a bright concrete skatepark"
              fill
              sizes="100vw"
