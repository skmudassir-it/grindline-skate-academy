    ...
    <header className="fixed inset-x-0 top-0 z-50 flex justify-center px-4 pt-4">
      ...
      >
        <Link href="/" className="flex min-h-11 items-center gap-2.5">
          <span className="flex size-9 items-center justify-center rounded-full bg-gradient-to-br from-primary to-[#5b21b6] text-sm font-bold text-white shadow-md shadow-primary/30">
            GL
          </span>
