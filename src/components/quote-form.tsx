...
export function QuoteForm() {
  ...
  const onSubmit = async (values: QuoteFormValues) => {
    ...
    try {
      ...
      toast.error("Network error", { description: "Please try again or call (555) 015-8890." });
    } finally {
      setSubmitting(false);
    }
  };
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5" noValidate>
      ...
      <div className="space-y-2">
        ...
        <Textarea
          id="qf-message"
          rows={5}
          placeholder="Tell us about your skating level, goals, or the party you are planning…"
          {...register("message")}
