...
export const metadata: Metadata = {
  title: "Projects",
  description:
    "Case studies from GrindLine Skate Academy: community park revamps, facility builds and city street programs across the Portland area.",
};
      ...
      <section className="px-4 pb-8 pt-36 sm:pt-40">
        <div className="mx-auto max-w-6xl">
          <SectionHeading
            ...
            title="Concrete, community and kickflips"
            subtitle="A few recent projects that show how we think — community-led, safety-first and finished on schedule."
          />
        </div>
      </section>
      ...
      <section className="px-4 py-12">
        <div className="mx-auto max-w-6xl">
          <SectionHeading
            ...
            subtitle="School partnership, community clinic or a birthday party for 15 — we would love to talk."
          />
          <Stagger className="mt-10 grid gap-6 sm:grid-cols-3" stagger={0.08}>
            {[
              { k: "1", v: "Tell us about your group or event — we reply within one business day." },
              { k: "2", v: "We plan the program, pricing and logistics with you." },
              { k: "3", v: "We bring the coaches, gear and stoke. Everyone rolls away smiling." },
            ].map((s) => (
              <StaggerItem key={s.k}>
